...
class WaypointService(Node):
    def __init__(self):
        ...
        self.waypoints = (
            self.parse_waypoints_param(waypoints_param)
            if waypoints_param != [""]
            else []
        )
        ...
        with self.lock:
            ...
            if request.command == "get":
                ...
                try:
                    ...
                    waypoints = []
                    for pair in request.argument.split(
                        ";"
...
# ros2 service call /mutate_waypoint_queue interface/srv/Waypoint "{command: 'pop', argument: ''}"
